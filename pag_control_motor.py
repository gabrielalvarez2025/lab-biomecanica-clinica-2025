...
def main_control_motor():
    ...
    **Limitaciones:**  
    ...
    st.plotly_chart(crear_plot_sinergia_ucm(title="Sinergia", synergy=True, ratio_var=1, mostrar_numeros=True, boton_agregar=True, n_points=1), 
    ...
    with col1:
        st.plotly_chart(crear_plot_sinergia_ucm(title="Not a synergy", synergy=False, n_points=24), 
                        use_container_width=True,
                        config={"staticPlot": True}
                        )
    
    with col2:
        st.plotly_chart(crear_plot_sinergia_ucm(title="A synergy", synergy=True, n_points=24), 
                        use_container_width=True,
                        config={"staticPlot": True}
                        )
