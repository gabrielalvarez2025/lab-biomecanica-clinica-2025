...
def main_control_motor():
    ...
    **Limitaciones:**  
    ...
    with col1:
        ...
        plot_no_sinergia = crear_plot_sinergia_ucm(mostrar_numeros=True, elipse_size=0.9,
            ratio_var=0.3
            )
    ...
    with col2:
        ...
        plot_es_sinergia = crear_plot_sinergia_ucm(mostrar_numeros=True, elipse_size=0.9,
            ratio_var=4
            )
