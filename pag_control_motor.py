...
def main_control_motor():
    ...
    **Limitaciones:**  
    ...
    with col1:
        ...
        plot_no_sinergia = crear_plot_sinergia_ucm(mostrar_numeros=False, mostrar_elipse=False,
                                                   var_ucm=0.3,
                                                   var_ort=0.45
                                                   )
    ...
    with col2:
        ...
        plot_es_sinergia = crear_plot_sinergia_ucm(mostrar_numeros=False, mostrar_elipse=False,
                                                   var_ucm=0.8,
                                                   var_ort=0.1
                                                   )
