...
def ejemplo_fr_botas():
    ...
    with col_sliders:
        ...
        st.markdown("Abajo, puedes deslizar los sliders para jugar con los parámetros del filtro y así ver cómo afectan la señal filtrada. Actualmente, el filtro está dejando pasar las frecuencias entre 0 y 10 Hz, y bloqueando todas las demás hacia derecha y hacia izquierda.")
