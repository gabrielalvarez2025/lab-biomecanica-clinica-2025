...
def ejemplo_fr_botas():
    ...
    with col_text1:
        ...
        st.markdown("Para poder iniciar y detener el registro, usas una app (ej. PhyPhox) que te permite acceder al acelerómetro en tiempo real y descargar los datos como tabla.")
