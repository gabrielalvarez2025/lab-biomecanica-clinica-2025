...
def ejemplo_fr_botas():
    ...
    with col_text_fr1:
        ...
        st.markdown("De forma alternativa, podemos contar el número de ciclos que ocurren en 15 segundos y luego multiplicar por 4 para hacer una estimación rápida.")
    ...
    with col_text_filter2:
        ...
        st.markdown("La respiración en reposo se repite pocas veces por segundo (20 a 30 rpm en un gato), por lo que ocurre a una frecuencia baja (0.3 a 0.5 Hz). En cambio, el ronroneo ocurre a una frecuencia más alta (unos 25 Hz).")
        ...
        st.markdown(f"En este momento, tu señal filtrada ignora todas las frecuencias inferiores a **{round(low_cut, 2)} Hz** y superiores a **{round(high_cut, 2)} Hz**. Estas mirando sólo las oscilaciones que ocurren entre los {round(low_cut, 2)} y {round(high_cut, 2)} Hz.")
