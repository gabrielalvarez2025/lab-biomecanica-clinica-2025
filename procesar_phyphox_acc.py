...
def ejemplo_fr_botas():
    ...
    with col_text_filter2:
        ...
        st.markdown("La respiración en reposo se repite pocas veces por segundo (20 a 30 rpm en un gato), por lo que ocurre a una frecuencia baja (0.3 a 0.5 Hz). En cambio, el ronroneo ocurre a una frecuencia más alta (aprox. 25 Hz).")
