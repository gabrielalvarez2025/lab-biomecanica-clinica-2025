def main_forceplate():
    ...
    if uploaded_file is not None:
        ...
        if not signals and not (show_Cx and show_Cy):
            st.warning("Selecciona al menos una señal para graficar o las posiciones Cx y Cy para el estatocinesiograma.")
            return
        ...
        # Gráficos individuales con ajuste dinámico eje Y
